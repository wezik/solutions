...
public class LongestSlideDownTest {
    ...
    @Test
    public void test() {
        System.out.println("should work for small pyramids");
        int[][] test = new int[][] {{3}, {7, 4}, {2, 4, 6}, {8, 5, 9, 3}};
        assertEquals(23, LongestSlideDown.longestSlideDown(test));

        System.out.println("should work for medium pyramids");
        ...
        assertEquals(1074, LongestSlideDown.longestSlideDown(test2));

        System.out.println("should work for huge pyramids");
        int[][] test3 = new int[][]{
                {59},
                {73, 41},
                {52, 40,  9},
        ...
        assertEquals(7273, LongestSlideDown.longestSlideDown(test3));
    }
}
